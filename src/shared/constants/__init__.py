...
PENNYWORTH_API_URL = os.environ.get(
    "PENNYWORTH_API_URL", f"https://api.{PENNYWORTH_BASE_DOMAIN}/v1"
)
"""
...
PENNYWORTH_USER_POOL_ID = os.environ.get(
    "PENNYWORTH_USER_POOL_ID", "PENNYWORTH_USER_POOL_ID_NOT_SET"
)
"""
...
PENNYWORTH_USER_POOL_CLIENT_ID = os.environ.get(
    "PENNYWORTH_USER_POOL_CLIENT_ID", "PENNYWORTH_USER_POOL_CLIENT_ID_NOT_SET"
)
"""
...
PENNYWORTH_IDENTITY_POOL_ID = os.environ.get(
    "PENNYWORTH_IDENTITY_POOL_ID", "PENNYWORTH_IDENTITY_POOL_ID_NOT_SET"
)
"""
...
PENNYWORTH_AWS_REGION = os.environ.get(
    "PENNYWORTH_AWS_REGION", "PENNYWORTH_AWS_REGION_NOT_SET"
)
"""
...
PENNYWORTH_API_VERSION = os.environ.get(
    "PENNYWORTH_API_VERSION", "PENNYWORTH_API_VERSION_NOT_SET"
)
"""
...
PENNYWORTH_API_SEMANTIC_VERSION = os.environ.get(
    "PENNYWORTH_API_SEMANTIC_VERSION", "PENNYWORTH_API_SEMANTIC_VERSION_NOT_SET"
)
"""
...
PENNYWORTH_GIT_COMMIT = os.environ.get(
    "PENNYWORTH_GIT_COMMIT", "PENNYWORTH_GIT_COMMIT_NOT_SET"
)
"""
...
PENNYWORTH_SESSION_DIR = os.environ.get(
    "PENNYWORTH_SESSION_DIR", os.path.join(os.path.expanduser("~"), ".pennyworth")
)
"""
...
PENNYWORTH_SESSION_FILE = os.environ.get(
    "PENNYWORTH_SESSION_FILE", "PENNYWORTH_SESSION_FILE_NOT_SET"
)
"""
